...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-marketgo-dev-key')
...
TEMPLATES = [{
    ...
    'OPTIONS': {'context_processors': [
        ...
        'django.contrib.messages.context_processors.messages', 'marketplace.context_processors.cart_count',
    ]},
}]
